...
training_set = training_set.drop(['Ticket', 'Cabin','Name'], axis=1)
training_set['Survived']=survive
#submission for titanic problem
X_train = training_set.drop(['PassengerId','Survived'], axis=1) # independent variables only
X_train = X_train[:891]
Y_train = training_set['Survived'][:891]
X_test = training_set.drop(['PassengerId','Survived'], axis=1)
X_test = X_test[891:]
...
final_result.to_csv('all-features.csv')