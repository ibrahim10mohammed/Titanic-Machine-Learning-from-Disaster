...
'''
        second version  gender and class 
'''
X_train = training_set[['Sex','Pclass']]# independent variables only
X_train = X_train[:891]
Y_train = training_set['Survived'][:891]
X_test = training_set[['Sex','Pclass']]
X_test = X_test[891:]
...
final_result.to_csv('gender-class.csv')